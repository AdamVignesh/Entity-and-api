...
namespace EntityTest.Controllers
{
    public class StudentModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Dept,DOB,Location")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Dept,DOB,Location")] StudentModel studentModel)
        {
